...
- **[GROUNDTRUTH](https://github.com/groundtruth-now/groundtruth-mcp)** - Recorded outcomes of Solana (pump.fun) and Robinhood Chain memecoin launches and the track record of their creators: coin records, a known-bad creator flag with its statistical basis, time-to-rug and creator replays. Remote MCP; x402 pay-per-call in USDC on Solana or Base.
